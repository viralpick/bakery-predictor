...
- [ ] **★차기 별도 스펙: 전처리 일반화** — 새 데이터/스펙이 와도 loader/adapter만 추가해 canonical schema 진입. 데이터 수령 사이드라 성격이 달라 backbone 스펙에서 분리(사용자 결정 2026-07-24). 참조: bonavi_loader_v2, docs/superpowers/specs/2026-07-23-new-data-integration-design.md.
